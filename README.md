...
Take Counter is an app that helps to track takes during recording sessions. It allows
...
current take without distraction. Alternatively, a filepath mode lets the take be
automatically incremented based on the number of files.
...
To setup your environment to run the app, run `make devbuild`, and to run the app, `make run`.
